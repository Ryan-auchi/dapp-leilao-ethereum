...
export declare namespace Checkpoints {
  ...
  export interface CuradoriaTokenInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
  ...
  export interface CuradoriaToken extends BaseContract {
    
    connect(runner?: ContractRunner | null): CuradoriaToken;
    waitForDeployment(): Promise<this>;

    interface: CuradoriaTokenInterface;
