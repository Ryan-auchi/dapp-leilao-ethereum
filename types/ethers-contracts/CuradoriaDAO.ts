...
encodeFunctionData(functionFragment: 'executarDeployLeilao', values: [string, AddressLike]): string;
...
decodeFunctionResult(functionFragment: 'executarDeployLeilao', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'votingPeriod', data: BytesLike): Result;
    ...
    export namespace LeilaoAprovadoECriadoEvent {
      export type InputTuple = [leilaoAddress: AddressLike, item: string, vendedor: AddressLike];
      export type OutputTuple = [leilaoAddress: string, item: string, vendedor: string];
      export interface OutputObject {leilaoAddress: string, item: string, vendedor: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace QuorumNumeratorUpdatedEvent {
      ...
      export interface OutputObject {oldQuorumNumerator: bigint, newQuorumNumerator: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  export interface CuradoriaDAO extends BaseContract {
    
    connect(runner?: ContractRunner | null): CuradoriaDAO;
    waitForDeployment(): Promise<this>;

    interface: CuradoriaDAOInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    executarDeployLeilao: TypedContractMethod<
      [nomeItem: string, vendedor: AddressLike, ],
      [void],
      'nonpayable'
    >
    ...
    quorumDenominator: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    "quorumNumerator()": TypedContractMethod<
      [],
      [bigint],
      'view'
    >
...
getFunction(nameOrSignature: 'eip712Domain'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'executarDeployLeilao'): TypedContractMethod<
      [nomeItem: string, vendedor: AddressLike, ],
      [void],
      'nonpayable'
    >;
...
getFunction(nameOrSignature: 'quorum'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'quorumDenominator'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'quorumNumerator(uint256)'): TypedContractMethod<
      [timepoint: BigNumberish, ],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'quorumNumerator()'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
...
getEvent(key: 'LeilaoAprovadoECriado'): TypedContractEvent<LeilaoAprovadoECriadoEvent.InputTuple, LeilaoAprovadoECriadoEvent.OutputTuple, LeilaoAprovadoECriadoEvent.OutputObject>;
...
getEvent(key: 'VotingPeriodSet'): TypedContractEvent<VotingPeriodSetEvent.InputTuple, VotingPeriodSetEvent.OutputTuple, VotingPeriodSetEvent.OutputObject>;
    ...
    filters: {
      ...
      'LeilaoAprovadoECriado(address,string,address)': TypedContractEvent<LeilaoAprovadoECriadoEvent.InputTuple, LeilaoAprovadoECriadoEvent.OutputTuple, LeilaoAprovadoECriadoEvent.OutputObject>;
      LeilaoAprovadoECriado: TypedContractEvent<LeilaoAprovadoECriadoEvent.InputTuple, LeilaoAprovadoECriadoEvent.OutputTuple, LeilaoAprovadoECriadoEvent.OutputObject>;
